...
: ${AMENT_CURRENT_PREFIX:="/root/workspaces/ros2_ws/install/slam_toolbox_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/slam_toolbox_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/slam_toolbox_demo/environment/path.sh"
